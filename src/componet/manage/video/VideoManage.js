  ...
  return(
    <div className="p-10 bg-white shadow-md mx-auto my-3 main"> 
      <div className="w-full h-10 mb-4">
        <p className="text-2xl text-left mx-10 font-bold">動画管理</p>
      </div>
      <div className="w-full mb-4 flex">
        <div className="w-1/2 h-10 px-10 flex">
          <div className="w-1/2 text-center text-sm font-medium py-2">動画ID</div>
      ...
      <Link to="/admin/manage/add_video"><Button type="primary" className="w-40 text-white border-gray-300 bg-purple-700"><div className="flex mx-2"><PlusCircleOutlined className="mr-2"/>動画新規登録</div></Button></Link>
      </div>
