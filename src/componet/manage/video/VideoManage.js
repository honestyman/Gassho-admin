...
const VideoManage=()=>{
  ...
  return(
    <div className="p-10 bg-white shadow-md mx-auto my-3 main"> 
      ...
      <Link to="//manage/add_video"><Button type="primary" className="w-40 text-white border-gray-300 bg-purple-700"><div className="flex mx-2"><PlusCircleOutlined className="mr-2"/>動画新規登録</div></Button></Link>
      </div>
