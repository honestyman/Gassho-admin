    ...
    <div className="p-10 bg-white shadow-md mx-auto my-3 main"> 
      ...
      <div className="w-full mb-4 flex">
        <div className="w-1/2 h-10 px-10 flex">
          <div className="w-1/2 text-center text-xl font-medium py-2">動画ID</div>
      ...
      <Link to="/admin/manage/add_video"><Button type="primary" className="w-40 text-black border-gray-300"><div className="flex mx-2"><PlusCircleOutlined className="mr-2"/>動画新規登録</div></Button></Link>
      </div>
