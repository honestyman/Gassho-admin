...
const Nav=()=>{
  return(
    <div className="w-1/5 h-full text-left border shadow-md px-3 py-5">
      <div className="w-full h-10 py-2 pl-1 rounded float-left font-bold text-xl hover:bg-gray-300">
      ...
      <div className="w-full h-10 py-2 px-1 rounded float-left font-bold text-xl hover:bg-gray-300">
